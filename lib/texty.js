...
Text.prototype.styleFromCSS = function(){
  var s = selectorStyle;

  // text
  this.listStyle(s('.text', 'list-style'))
    .size(s('.text', 'font-size'))
    .font(s('.text', 'font-family'))
    .color(s('.text', 'color'))
    .selectionBackground(s('.text', 'background'));
...
Text.prototype.drawText = function(ctx, x, y, height, text){
  ...
  ctx.font = height + 'px ' + this._families;
...
Text.prototype.draw = function(ctx){
  ...
  switch (this._listStyle) {
    case 'numbered':
      this.drawLineDecoration(ctx, x, y, height, text, function(i){
        return ++i + '.';
      });
      break;
    case 'bullet':
      this.drawLineDecoration(ctx, x, y, height, text, '●');
      break;
  }
